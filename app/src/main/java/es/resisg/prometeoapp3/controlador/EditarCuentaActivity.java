...
public class EditarCuentaActivity extends AppCompatActivity {
    ...
    public void editarCuenta(View view){
        ...
        if(validarUsuarioContrasenaNombre(String.valueOf(usuario_EXTAR),contrasena,nombre)){
            ...
            String respuesta =new peticiones("http://www.ieslassalinas.org/APP/appValidaUsuario.php",String.valueOf(usuario_EXTAR),contrasena).conseguirNombreUsuario().replaceAll("[^a-zA-Z0-9áéíóúüÁÉÍÓÚÜ]", "");
