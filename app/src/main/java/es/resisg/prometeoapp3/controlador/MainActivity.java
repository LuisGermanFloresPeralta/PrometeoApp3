...
public class MainActivity extends AppCompatActivity {
    ...
    public void init(){
        ...
        String respuesta =new peticiones("http://ieslassalinas.org/APP/appValidaUsuario.php",String.valueOf(gestionSesion.getUsuario()),gestionSesion.getContrasena(),MainActivity.this).conseguirNombreUsuario();
    ...
    public void Aceder(View view){
        ...
        if(validarUsuarioContrasena(usuario,contrasena)){
            String respuesta =new peticiones("http://ieslassalinas.org/APP/appValidaUsuario.php",usuario,contrasena,MainActivity.this).conseguirNombreUsuario();
            if(respuesta.equals("0")){
