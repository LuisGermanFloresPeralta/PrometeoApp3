...
public class MainActivity extends AppCompatActivity {
    ...
    public void Aceder(View view){
        ...
        if(validarUsuarioContrasena(usuario,contrasena)){
            String respuesta =new peticiones("http://192.168.1.173/WEB/APP/appValidaUsuario.php",usuario,contrasena).conseguirNombreUsuario().replaceAll("[^a-zA-Z0-9áéíóúüÁÉÍÓÚÜ]", "");
